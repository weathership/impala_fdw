...
class TCLIServiceNull : virtual public TCLIServiceIf {
 public:
  ...
  void GetLog(TGetLogResp& /* _return */, const TGetLogReq& /* req */) override {
    return;
  }
};
...
class TCLIService_GetLog_args {
 public:
  ...
  TCLIService_GetLog_args(const TCLIService_GetLog_args&);
  TCLIService_GetLog_args& operator=(const TCLIService_GetLog_args&);
  TCLIService_GetLog_args() noexcept;

  virtual ~TCLIService_GetLog_args() noexcept;
  TGetLogReq req;
...
class TCLIService_GetLog_pargs {
 public:
  ...
  virtual ~TCLIService_GetLog_pargs() noexcept;
...
class TCLIService_GetLog_result {
 public:
  ...
  TCLIService_GetLog_result(const TCLIService_GetLog_result&);
  TCLIService_GetLog_result& operator=(const TCLIService_GetLog_result&);
  TCLIService_GetLog_result() noexcept;

  virtual ~TCLIService_GetLog_result() noexcept;
  TGetLogResp success;
...
class TCLIService_GetLog_presult {
 public:
  ...
  virtual ~TCLIService_GetLog_presult() noexcept;
  TGetLogResp* success;
  ...
  TCLIServiceConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr< ::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
 ...
 public:
  ...
  void GetLog(TGetLogResp& _return, const TGetLogReq& req) override;
  int32_t send_GetLog(const TGetLogReq& req);
  void recv_GetLog(TGetLogResp& _return, const int32_t seqid);
 protected:
  std::shared_ptr< ::apache::thrift::protocol::TProtocol> piprot_;
  std::shared_ptr< ::apache::thrift::protocol::TProtocol> poprot_;
  ::apache::thrift::protocol::TProtocol* iprot_;
