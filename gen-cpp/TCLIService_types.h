...
class TGetLogReq : public virtual ::apache::thrift::TBase {
 public:
...
class TGetLogResp : public virtual ::apache::thrift::TBase {
 public:

  TGetLogResp(const TGetLogResp&);
  TGetLogResp& operator=(const TGetLogResp&);
  TGetLogResp() noexcept;

  virtual ~TGetLogResp() noexcept;
  TStatus status;
  std::string log;
