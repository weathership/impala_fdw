...
TCLIService_GetLog_args::~TCLIService_GetLog_args() noexcept {
}
...
TCLIService_GetLog_pargs::~TCLIService_GetLog_pargs() noexcept {
}
...
TCLIService_GetLog_result::~TCLIService_GetLog_result() noexcept {
}
...
TCLIService_GetLog_presult::~TCLIService_GetLog_presult() noexcept {
}
...
void TCLIServiceConcurrentClient::GetLog(TGetLogResp& _return, const TGetLogReq& req)
{
  int32_t seqid = send_GetLog(req);
  recv_GetLog(_return, seqid);
}

int32_t TCLIServiceConcurrentClient::send_GetLog(const TGetLogReq& req)
{
  int32_t cseqid = this->sync_->generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(this->sync_.get());
  oprot_->writeMessageBegin("GetLog", ::apache::thrift::protocol::T_CALL, cseqid);
...
void TCLIServiceConcurrentClient::recv_GetLog(TGetLogResp& _return, const int32_t seqid)
{
