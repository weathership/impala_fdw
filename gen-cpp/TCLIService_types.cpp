...
const std::map<int, const char*> _TProtocolVersion_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(7, _kTProtocolVersionValues, _kTProtocolVersionNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
const std::map<int, const char*> _TTypeId_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(20, _kTTypeIdValues, _kTTypeIdNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
const std::map<int, const char*> _TOperationState_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(8, _kTOperationStateValues, _kTOperationStateNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
TOpenSessionReq::TOpenSessionReq() noexcept
   : client_protocol(static_cast<TProtocolVersion::type>(5)),
     username(),
     password() {
}
...
TOpenSessionResp::TOpenSessionResp() noexcept
   : serverProtocolVersion(static_cast<TProtocolVersion::type>(5)) {
}
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->infoType = static_cast<TGetInfoType::type>(ecast209);
          isset_infoType = true;
        } else {
          xfer += iprot->skip(ftype);
        }
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->operationState = static_cast<TOperationState::type>(ecast270);
...
TFetchResultsReq::TFetchResultsReq() noexcept
   : orientation(static_cast<TFetchOrientation::type>(0)),
     maxRows(0),
     fetchType(0) {
}
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->orientation = static_cast<TFetchOrientation::type>(ecast285);
...
TGetLogReq::~TGetLogReq() noexcept {
}
...
bool TGetLogReq::operator==(const TGetLogReq & rhs) const
{
  if (!(operationHandle == rhs.operationHandle))
    return false;
  return true;
...
TGetLogReq::TGetLogReq(const TGetLogReq& other302) {
  operationHandle = other302.operationHandle;
}
TGetLogReq& TGetLogReq::operator=(const TGetLogReq& other303) {
...
TGetLogResp::~TGetLogResp() noexcept {
}
...
bool TGetLogResp::operator==(const TGetLogResp & rhs) const
{
  if (!(status == rhs.status))
    return false;
  if (!(log == rhs.log))
...
TGetLogResp::TGetLogResp(const TGetLogResp& other304) {
  status = other304.status;
  log = other304.log;
}
TGetLogResp& TGetLogResp::operator=(const TGetLogResp& other305) {
